...
public class ExerciseInfo{
        ...
        if(dateAnswer.equals("b")){
            do {
                ...
                try {
                    ...
                    incorrectDate = true;
                    System.out.println("Incorrect date format. Please re-enter in this format mm-dd-yyyy.");
                }
            }while (incorrectDate);
    ...
    public void addNewExercise(){
        ...
        System.out.print("Enter the MET value of exercise(Metabolic Equivalent of Task) : ");
